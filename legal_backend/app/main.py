...
async def _persist_phone_call(
    ...
    try:
        ...
        # Call completion should not crash the websocket monitor if persistence
        ...
        async with websockets.connect(
            ...
            async for raw in websocket:
                ...
                if event_type == "conversation.item.input_audio_transcription.completed":
                    ...
                    if text:
                        cast_lines = record.setdefault("caller_lines", [])
                        if isinstance(cast_lines, list):
                    ...
                    if text:
                        cast_lines = record.setdefault("assistant_lines", [])
                        if isinstance(cast_lines, list):
                            cast_lines.append(text)
