            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    status?.active == true
                        ? 'Android reports an active VPN connection. Open WARP to verify its switch shows Connected.'
                        : 'Free encrypted protection through Cloudflare. Install or open WARP, accept Android VPN permission, and switch it to Connected.',
                  ),
                  const SizedBox(height: 12),
                  FilledButton.icon(
